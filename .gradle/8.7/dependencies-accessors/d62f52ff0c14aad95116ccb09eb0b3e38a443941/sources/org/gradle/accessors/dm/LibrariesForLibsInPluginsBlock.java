...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final MaplibreLibraryAccessors laccForMaplibreLibraryAccessors = new MaplibreLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>maplibre</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public MaplibreLibraryAccessors getMaplibre() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForMaplibreLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class MaplibreLibraryAccessors extends SubDependencyFactory {

        public MaplibreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.maplibre.gl:android-sdk</b> coordinates and
         * with version reference <b>maplibre</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("maplibre.android");
        }
    ...
    public static class UsbSerialLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>usbSerial</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>maplibre</b> with value <b>11.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaplibre() { return getVersion("maplibre"); }
        ...
        /**
         * Version alias <b>usbSerial</b> with value <b>3.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUsbSerial() { return getVersion("usbSerial"); }
