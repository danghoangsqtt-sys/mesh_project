...
from app.routers import nodes, events, commands, status, ota, tactical, ai, vision, map, llm
...
app.include_router(tactical.router, prefix="/api/tactical", tags=["Tactical"])
